...
public class SearchProductAndFetchDetailsTest {
        ...
        if (driver.getTitle().contains("Shoppers")) {
            ...
            if (driver.getTitle().contains("Login")) {
                ...
                if (driver.getTitle().contains("Shoppers")) {
                    ...
                    Thread.sleep(3000);
                    WebElement text = driver.findElement(By.xpath("(//div[@class='featuredProducts_footerLeft__PmkNa'])[1]"));
                    System.out.println(text.getText());
                    Thread.sleep(200);
                    // Take a screenshot after deletion
                    TakesScreenshot ts = (TakesScreenshot) driver;
                    File source = ts.getScreenshotAs(OutputType.FILE);
                    File destination = new File("./src/test/resources/screenshots/SearchProductandFetch.png");
