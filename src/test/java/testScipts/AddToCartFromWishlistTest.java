...
public class AddToCartFromWishlistTest {
	        ...
	        if (driver.getTitle().contains("Shoppers")) {
	            ...
	            if (driver.getTitle().contains("Login")) {
	                ...
	                if (driver.getTitle().contains("Shoppers")) {
	        			...
	        			Thread.sleep(1000);
	        		    driver.findElement(By.xpath("//button[@class='MuiButtonBase-root MuiButton-root MuiButton-outlined MuiButton-outlinedPrimary MuiButton-sizeSmall MuiButton-outlinedSizeSmall  css-k58djc']")).click();
	        		    driver.findElement(By.id("cartIcon")).click();
	        			  // Take a screenshot after deletion
	                    TakesScreenshot ts = (TakesScreenshot) driver;
	                    File source = ts.getScreenshotAs(OutputType.FILE);
	                    File destination = new File("./src/test/resources/screenshots/AddToCardFromWishList.png");
